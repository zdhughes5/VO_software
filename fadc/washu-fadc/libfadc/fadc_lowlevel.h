...
#define WR_PEDVAR_RST      0xa    /* issue command to reset pedvar module */
...
#define WR_PEDVAR_16KHZ    0x0    /* issue command to enable pedvar module and set integration window frequency to 16 KHz*/
