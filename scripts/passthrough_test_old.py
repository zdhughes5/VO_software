...
def main(filename, channel):
    """Parse binary file and plot sum and sum-of-squared-samples data vs timestamp for a specific channel"""
    timestamps = []
    event_numbers = []
    all_sums = []
    all_sums_sq = []
    ...
    axes[1].set_xlabel('Time relative to first event (s)')
